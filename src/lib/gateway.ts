 ...
 * keeps backward compatibility with legacy gateway integrations. When none of
 * the above resolves to a role at all, `src/routes/login.tsx`'s hidden auth
 * bridge mints a permission-less guest session (view-only) instead of
