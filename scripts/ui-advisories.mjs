...
if (existsSync(PAGE_ROOT) && statSync(PAGE_ROOT).isDirectory()) {
  ...
  const AFFORDANCE =
    /apiUrl\(|useRequest\(|usePolling\(|createServerFn|<FormDialog|<Drawer\b|<ConfirmDialog|<RecommendationAction|<ImpactPreviewDialog|onSubmit=|fetch\(/;
